# The Travis Client [![Build Status](https://app.travis-ci.com/veryangryboss-api/travis.rb.svg?branch=main)](https://app.travis-ci.com/veryangryboss-api/travis.rb)
