# The Travis Client [![Build Status](https://github.com/veryangryboss-api/travis.rb.svg?branch=main)](https://app.travis-ci.com/github/veryangryboss-api/travis.rb)
